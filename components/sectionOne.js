  ...
  return (
    <div className="grid md:grid-cols-2 gap-10">
      ...
      <div className="info flex justify-center flex-col">
        ...
        <div className="title">
          <Link href={"/"}><a className="text-3xl md:text-5xl font-bold text-gray-800 hover:text-gray-600 duration-300">Your most unhappy customers are your greatest source of learning</a></Link>
        </div>
